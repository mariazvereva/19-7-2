...
# Homework 19.7.2
    def add_new_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод отправляет сервер данные о добавляемом питомце без раpмещения фотографии митомца и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца"""
    ...
    def add_pets_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер фотографию уже добавленного питомца и возвращает статус
